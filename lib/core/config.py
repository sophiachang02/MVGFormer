...
config.POSE_RESNET.USE_DEPTH = False
...
config.DATASET.NUM_VIEWS = 5
config.DATASET.USE_RETINAFACE = False
config.DATASET.USE_DEPTH = False
config.DATASET.RETINAFACE_ROOT = ""
config.DATASET.RETINAFACE_CHECKPOINT = ""
